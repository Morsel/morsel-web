  ...
  public_files: {
    ...
    common: {
      js: [
        ...
        'src/common/morsels/morselGrid.js',
        'src/common/morsels/morselSummary.js',
        'src/common/morsels/morselTaggedUserList.js',
      ...
      tpl: [
        ...
        'src/common/morsels/morselGrid.tpl.html',
        'src/common/morsels/morselGridOverlay.tpl.html',
