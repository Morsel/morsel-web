describe( 'ApiPosts factory', function() {
  ...
  describe('function getPosts', function() {
    beforeEach(inject(function (_$httpBackend_, APIURL) {
      ...
      httpBackend.expectGET(APIURL+'/posts.json?api_key=1').respond('[{"name":"tester"},{"name":"tester2"}]');
    }));
  ...
  describe('function getPost', function() {
    beforeEach(inject(function (_$httpBackend_, APIURL) {
      httpBackend = _$httpBackend_;
      httpBackend.expectGET(APIURL+'/posts/1.json?api_key=1').respond('[{"name":"tester"}]');
    }));
