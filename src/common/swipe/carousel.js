/**
 * modified to include ability to shut carousel off conditionally
 */
        ...
        return {
            ...
            compile: function(tElement, tAttributes) {
                ...
                return function(scope, iElement, iAttributes, containerCtrl) {
                    ...
                    if (angular.isDefined(iAttributes.rnCarouselOff) && (tAttributes.rnCarouselOff === 'true')) {
                        //remove the css that we'd applied
                        iElement.removeClass('rn-carousel-slides');
                        iElement.children().removeClass('rn-carousel-slide');
                        return;
                    }
